...
class EventImageGenerator:
    def __init__(self):
        ...
        self.events_output_file = "events_images_output.json"
        
    def load_events(self, filename="pensacola_events.json", limit=5):
...
def main():
    ...
    try:
        ...
        if success:
            ...
            print("📋 Check holiday_images/ folder for generated images")
